          ...
          <Col xs={24} lg={8}>
            <div className={styles.infoPanel}>
              <div className={styles.panelCard}>
                <Title level={4} className={styles.infoTitle}>Project Information</Title>
                ...
                <div className={styles.infoRow}>
                  ...
                  <Text className={styles.infoValue}>{item.info.location}</Text>
                </div>

                <div className={styles.infoRow}>
                  <Text className={styles.infoLabel}>Tech Stack</Text>
                  <Text className={styles.infoValue}>{item.info.techstack}</Text>
                </div>
              </div>
